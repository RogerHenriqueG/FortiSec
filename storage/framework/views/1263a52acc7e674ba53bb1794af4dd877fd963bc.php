        ...
        <div class="position-relative">
            <div class="container-fluid space-2 space-lg-0">
                <div class="row justify-content-sm-center align-items-lg-center text-center">
                    ...
                    <div class="col-sm-8 col-lg-4" id="contact">
                        <!-- Title -->
                        <div class="mb-5">
                            <h2 class="h1">Pronto para expandir o seu negócio?</h2>
                            <p>Preencha o formulario e retornaremos contato com todas as informações</p>
                        </div>
                        <!-- End Title -->
                        ...
                        <form class="js-validate">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control mt-2" name="name" id="signupSrName" placeholder="Nome" aria-label="Name" required>
                                <textarea name="message" class="form-control mt-2" id="message" cols="1" rows="3" placeholder="Deixe sua mensagem aqui"></textarea>
...
<?php /**PATH /home/roger_kyfler/www/projetos/fortisec/resources/views/home/subscription.blade.php ENDPATH**/ ?>