    <div class="position-relative bg-primary overflow-hidden">
        <div class="container position-relative z-index-2 space-top-3 space-top-md-4 space-bottom-3 space-bottom-md-4">
            <div class="w-md-80 w-xl-90 text-center mx-md-auto">
                <div class="mb-7">
                    <h1 class="display-4 text-white mb-3">Lorem Ipsum is simply dummy text of the printing and</h1>
                    <p class="display-6 lead text-white mb-4">Lorem Ipsum has been the industry's standard dummy! =)</p>
                </div>
...
<?php /**PATH /home/roger_kyfler/www/facul/FortiSec/resources/views/home/hero.blade.php ENDPATH**/ ?>