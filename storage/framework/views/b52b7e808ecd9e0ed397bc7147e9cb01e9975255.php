    <div id="featuresSection" class="container space-2 space-lg-3">
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-6 mb-9 mb-lg-0">
                <div class="mb-3">
                    <h2 class="h1">A segurança inteligente começa com a FortiSec</h2>
                </div>

                <p>Segurança rápida e em qualquer lugar. Estas são algumas das caracteristicas da <strong>FortiSec</strong>. Vamos colocar a segurança em todos os lugares, para alcançar o sucesso diante das incertezas</p>
                <p>Quando cada segundo conta, você precisa de uma defesa unificada para identificar, orquestrar e automatizar sua resposta a ameaças. As soluções da <strong>FortiSec</strong> ajudam você a prosperar diante do cenário de incerteza cibernética.</p>
...
<?php /**PATH /home/roger_kyfler/www/projetos/fortisec/resources/views/home/presentation.blade.php ENDPATH**/ ?>