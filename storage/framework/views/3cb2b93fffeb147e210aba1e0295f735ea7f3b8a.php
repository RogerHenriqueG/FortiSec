    <div class="position-relative bg-primary overflow-hidden">
        <div class="container position-relative z-index-2 space-top-3 space-top-md-4 space-bottom-3 space-bottom-md-4">
            <div class="w-md-80 w-xl-90 text-center mx-md-auto">
                <div class="mb-7">
                    <h1 class="display-4 text-white mb-3">Alinhe sua estratégia de segurança aos seus negócios</h1>
                    <p class="display-6 lead text-white mb-4">Proteja seus ativos digitais, usuários e dados =)</p>
                </div>
                <a class="btn btn-light btn-wide transition-3d-hover" href="#contact">Comece agora</a>
...
<?php /**PATH /home/roger_kyfler/www/projetos/fortisec/resources/views/home/hero.blade.php ENDPATH**/ ?>