    <div class="overflow-hidden" id="pricing">
        <div class="container pb-4">
            ...
            <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                <h2 class="h1">Flexibilidade e transparência</h2>
                <p>Preços e planos que cabem no seu orçamento. ;)</p>
            </div>
            <!-- End Title -->

            <!-- Toggle Switch -->
            <div class="d-flex justify-content-center align-items-center mb-11">
                <span class="font-size-1 text-muted">Mensal</span>
                ...
                <div class="position-relative">
                    <span class="font-size-1 text-muted">Anual</span>
                    ...
                    <figure class="position-absolute top-0 text-nowrap mt-n5 ml-3 ml-md-7">
                        ...
                        <span class="badge badge-primary badge-pill py-sm-2 px-sm-3">Anual c/ desconto</span>
                    </figure>
                    <!-- End Arrow -->
                </div>
            </div>
                    ...
                    <div class="card shadow-none h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                                <div class="media-body">
                                    Mobile Sync (Outlook, Web, Android. iOS)
                                </div>
                            </div>
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                                <div class="media-body">
                                    Compartilhamento de tudo
                                </div>
                            </div>
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                                <div class="media-body">
                                    Chat só entre a empresa
                                </div>
                            </div>
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                        ...
                        <div class="card-footer border-0">
                            <button type="button" class="btn btn-soft-primary btn-block transition-3d-hover disabled">Vamos Começar</button>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 px-lg-5 mb-5">
                    ...
                    <div class="position-relative">
                        <div class="card shadow-lg h-100">
                            <!-- Header -->
                            <div class="card-header border-0 text-center">
                                <span class="d-block h3 mb-0">Inter</span>
                                <span class="d-block">
                                    <span class="font-size-4 text-primary font-weight-bold">
                                        <span class="mr-n2">R$</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="media font-size-1 text-body mb-3">
                                    <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                                    <div class="media-body">
                                        Integração com Drive (como DropBox)
                                    </div>
                                </div>
                                <div class="media font-size-1 text-body mb-3">
                                    <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                    ...
                    <div class="card shadow-none h-100">
                        ...
                        <div class="card-body">
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
                                <div class="media-body">
                                    <strong style="color: red">100GB</strong> de espaço
                                </div>
                            </div>
                            <div class="media font-size-1 text-body mb-3">
                                <i class="fas fa-check-circle text-success mt-1 mr-2"></i>
...
<?php /**PATH /home/roger_kyfler/www/facul/FortiSec/resources/views/home/pricing.blade.php ENDPATH**/ ?>