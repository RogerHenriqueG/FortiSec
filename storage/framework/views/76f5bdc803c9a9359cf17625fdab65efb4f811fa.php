    <div id="featuresSection" class="container space-2 space-lg-3">
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-6 mb-9 mb-lg-0">
                <div class="mb-3">
                    <h2 class="h1">Adicionar titulo do texto aqui</h2>
                </div>

                <p>Email seguro, rápido e em qualquer lugar. Estas são algumas das caracteristicas do <strong>email360</strong>, que você tem. Emails, contatos, agenda e arquivos em <strong> um só lugar e em todos os lugares, incrível né?</strong></p>
                <p>Com uma única conta, você pode acessar por Tables, Celulares, Desktops e Notebooks. Não precisa instalar nada! É tudo simples, rápido, prático e seguro.</p>
                <p>Quer backup dos seus email? Aqui tem!</p>
                <p>Precisou de ajuda? Nosso time de suporte está a um clique de distãncia esperando sua chamada para ajudar. Experimente!</p>
...
<?php /**PATH /home/roger_kyfler/www/facul/FortiSec/resources/views/home/presentation.blade.php ENDPATH**/ ?>