        ...
        <div id="logoAndNav" class="container">
            ...
            <nav class="js-mega-menu navbar navbar-expand-lg">
                ...
                <a class="navbar-brand" href="/" aria-label="email360">
                    ...
                    <img src="{{ url('assets/img/email360/logo_email360_branco.png') }}" alt="Logo">
                </a>
                <!-- End Logo -->
                ...
                <div class="navbar-nav-wrap-content text-center">
                    <div class="d-none d-lg-block">
                        <a class="btn btn-sm btn-light transition-3d-hover" href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/" target="_blank">Buy Now</a>
                    </div>
                </div>
                    ...
                    <div class="navbar-body header-abs-top-inner">
                      ...
                      "desktop": {
                        ...
                        "maxWidth": "440px"
                                ...
                                <!-- Shop - Mega Menu -->
                                <div class="hs-mega-menu dropdown-menu hs-position-right mega-menu-position-right-fix" aria-labelledby="shopMegaMenu">
                      ...
                      "desktop": {
                        ...
                        "maxWidth": "260px"
                                ...
                                <!-- Docs - Submenu -->
                                <div class="hs-mega-menu dropdown-menu mega-menu-position-right-fix" aria-labelledby="docsMegaMenu" style="min-width: 330px;">
                                    <!-- Promo Item -->
